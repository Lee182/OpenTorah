...
db.torah.update({ "heb" : "הַשַּׁבָּת" },{$set:{eng:"the~CEASING"}}, {multi:true})הַשְּׁבִיעִת
db.torah.update({ "heb" : "הַשְּׁבִיעִי" },{$set:{eng:"the~SEVENTH"}}, {multi:true})
db.torah.update({ "heb" : "הַשְּׁבִעִי" },{$set:{eng:"the~SEVENTH"}}, {multi:true})
db.torah.update({ "heb" : "הַשָּׁמָיִם"},{$set:{eng:"the~SKY~s2"}}, {multi:true})
db.torah.update({ "heb" : "הַשָּׁמַיִם"},{$set:{eng:"the~SKY~s2"}}, {multi:true})
db.torah.update({ "heb" : "הַשָּׁמַיְמָה"},{$set:{eng:"in~the~FIELD"}}, {multi:true})
db.torah.update({ "heb" : ""},{$set:{eng:"and~from~THERE"}}, {multi:true})
db.torah.update({ "heb" : "מִשָּׁם"},{$set:{eng:"from~THERE"}}, {multi:true})
db.torah.update({ "heb" : "וּמִשָּׁם"},{$set:{eng:"and~from~THERE"}}, {multi:true})
// db.torah.update({ "heb" : ""},{$set:{eng:"and~from~THERE"}}, {multi:true})
// db.torah.find({heb: ""})
